...
const QATracking = lazy(() => import("@/pages/qa-tracking"));
const SOWRequests = lazy(() => import("@/pages/admin/sow-requests"));
const PricingCatalog = lazy(() => import("@/pages/admin/pricing-catalog"));
const FinanceAnalytics = lazy(() => import("@/pages/admin/finance-analytics"));
const SalesDashboard = lazy(() => import("@/pages/sales/dashboard"));
const MySOWRequests = lazy(() => import("@/pages/customer/my-sow-requests"));
const AdvancedThrottling = lazy(() => import("@/pages/settings/advanced-throttling"));
const ClusterConfig = lazy(() => import("@/pages/settings/cluster-config"));
